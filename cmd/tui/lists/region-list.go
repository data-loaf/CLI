...
var Regions = []list.Item{
	...
	item{title: "ap-east-1", desc: "Asia Pacific (Hong Kong)"},
	item{title: "ap-south-2", desc: "Asia Pacific (Hyderabad)"},
	item{title: "ap-southeast-3", desc: "Asia Pacific (Jakarta)"},
	item{title: "ap-southeast-4", desc: "Asia Pacific (Melbourne)"},
	item{title: "ap-south-1", desc: "Asia Pacific (Mumbai)"},
	item{title: "ap-northeast-3", desc: "Asia Pacific (Osaka)"},
	...
	item{title: "ca-west-1", desc: "Canada West (Calgary)"},
	...
	item{title: "eu-south-1", desc: "Europe (Milan)"},
	item{title: "eu-west-3", desc: "Europe (Paris)"},
	item{title: "eu-south-2", desc: "Europe (Spain)"},
	item{title: "eu-north-1", desc: "Europe (Stockholm)"},
	item{title: "eu-central-2", desc: "Europe (Zurich)"},
	item{title: "il-central-1", desc: "Israel (Tel Aviv)"},
	item{title: "me-south-1", desc: "Middle East (Bahrain)"},
	item{title: "me-central-1", desc: "Middle East (UAE)"},
	item{title: "sa-east-1", desc: "South America (São Paulo)"},
	item{title: "us-gov-east-1", desc: "AWS GovCloud (US-East)"},
	item{title: "us-gov-west-1", desc: "AWS GovCloud (US-West)"},
}
